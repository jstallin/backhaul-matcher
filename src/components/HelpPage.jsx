...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Go to Start Backhaul Request. Select the fleet, enter the datum point (the city/state where the truck currently is), pick the equipment type and pickup date, then submit. Matching runs automatically and results are sorted best-first.',
  },
  {
  ...
  },
  {
    ...
    a: 'Relay mode is for fleets where drivers always return to a home terminal between loads. When enabled, OOR miles are calculated as the full driver loop: home → pickup → delivery → home, rather than datum → pickup → delivery → home. Toggle it on the request form.',
  },
  {
