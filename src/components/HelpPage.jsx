...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Go to Start Backhaul Request. Select the fleet, enter the pick-up location (the city/state where the truck currently is), pick the equipment type and pickup date, then submit. Matching runs automatically and results are sorted best-first.',
  },
  {
  ...
  },
  {
    ...
    a: 'Relay mode is for fleets where drivers always return to a home terminal between loads. When enabled, OOR miles are calculated as the full driver loop: home → load pickup → delivery → home, rather than pick-up location → load pickup → delivery → home. Toggle it on the request form.',
  },
  {
